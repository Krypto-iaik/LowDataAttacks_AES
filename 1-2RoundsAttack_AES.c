...
void encryption1Round(word8 initialMessage[][4], word8 initialKey[][4], word8 *ciphertext){
...
void decryption(word8 initialMessage[][4], word8 initialKey[][4], word8 *textDecryption){
  ...
  for(i=0;i<4;i++){
    for(j=0;j<4;j++)
      *(textDecryption+j+4*i)=state[i][j];
  }
...
int main()
{
    ...
    printf("Digit 1 for the attack on 1 round and 2 for the attack on 2 Rounds:\n");
    scanf("%d", &i);
